        ...
        <div>
          ...
          <nav className="mt-8 space-y-4">
            {[
              ...
              <button key={name} onClick={() => toggleSidebar(false)} className="w-full text-left">
                <Link to={path} className="flex items-center space-x-4 p-3 rounded-lg cursor-pointer transition hover:bg-gray-100 text-gray-700">
